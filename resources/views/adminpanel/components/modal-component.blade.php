        ...
        @foreach ($formErrors as $item)
            @if($errors->has($item))
                <script>
                    ...
                    switch(showModal) {
                        case 'blogCreateModalJsFunction':
                            blogCreateModalJsFunction();
                            break;
                        case 'blogEditModalJsFunction':
                            blogEditModalJsFunction('{{ old("_blog_id") }}');
                            break;
                        ...
                        case 'roleCreateModalJsFunction':
                            roleCreateModalJsFunction();
                            break;
                        case 'roleEditModalJsFunction':
                            roleEditModalJsFunction('{{ old("_role_id") }}');
                            break;
